<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课题简介" prop="ketijianjie">
          <el-input v-model="ruleForm.ketijianjie" 
              placeholder="课题简介" clearable  :readonly="ro.ketijianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课题简介" prop="ketijianjie">
              <el-input v-model="ruleForm.ketijianjie" 
                placeholder="课题简介" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课题文件" prop="ketiwenjian">
          <el-input v-model="ruleForm.ketiwenjian" 
              placeholder="课题文件" clearable  :readonly="ro.ketiwenjian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课题文件" prop="ketiwenjian">
              <el-input v-model="ruleForm.ketiwenjian" 
                placeholder="课题文件" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="论文上传" prop="lunwenshangchuan">
          <file-upload
          tip="点击上传论文上传"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.lunwenshangchuan?ruleForm.lunwenshangchuan:''"
          @change="lunwenshangchuanUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.lunwenshangchuan" label="论文上传" prop="lunwenshangchuan">
            <el-button type="text" size="small" @click="download(ruleForm.lunwenshangchuan)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.ketimingcheng = true;
          ...
          if(o=='ketijianjie'){
            this.ruleForm.ketijianjie = obj[o];
	    this.ro.ketijianjie = true;
            continue;
          }
          if(o=='ketiwenjian'){
	    ...
	    this.ro.lunwenmingcheng = true;
          ...
          if(o=='lunwenshangchuan'){
            this.ruleForm.lunwenshangchuan = obj[o];
	    this.ro.lunwenshangchuan = true;
            continue;
          }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `lunwenguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.lunwenguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    lunwenshangchuanUploadChange(fileUrls) {
	this.ruleForm.lunwenshangchuan = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
